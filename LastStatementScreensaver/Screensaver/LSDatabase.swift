...
struct LSDatabase {
    fileprivate enum Key {
        static let backgroundColor = "ankiScreenSaverBackgroundColor"
        static let textColor = "ankiScreenSaverTextColor"
        static let lastSyncTime = "ankiScreenSaverLastSyncTime"
        static let executionJSON = "ankiScreenSaverExecutionJSON"
    }

    static var standard: UserDefaults {
        var database = UserDefaults.standard
        if let customDatabase = UserDefaults(suiteName: "com.harrymoreno.ankiScreenSaverSettings") {
